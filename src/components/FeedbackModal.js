...
function FeedbackModal({ className }) {
    ...
    useEffect(() => {
        const handleKeyDown = async (event) => {
            ...
            // Handle Escape key to skip feedback
            if (event.key === 'Escape' && !submitted) {
                event.preventDefault();
                
                console.log('⏭️ Skipping feedback...');
                
                // Navigate to landing page immediately (no feedback submission)
                history.push('/');
            }
        };
                ...
                {submitted ? (
                    ...
                    <div className="feedback-form">
                        ...
                        <div className="keyboard-hint">
                            Press keys 1-5 to rate • Press Escape to skip
                        </div>
                        ...
                        {ratingSelected && (
                            <div className="written-feedback-section">
                                ...
                                <div className="submit-instruction">
                                    <p>Press Enter to continue • Press Escape to skip</p>
                                </div>
                            </div>
                        )}
                    </div>
